                                ...
                                child :Padding (
                                  ...
                                  child: Column (
                                    children: [
                                      ...
                                      Text("Questions and answers", style: TextStyle (
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize:  20.0
                                      )),
                                ...
                                child :Padding (
                                  ...
                                  child: Column (
                                    children: [
                                      ...
                                      SizedBox (height: 10.0),
                                      Text("View Achievements", style: TextStyle (
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize:  20.0
                                      )),
                        ...
                        child: Card(
                            ...
                            child: Center (
                                child :Padding (
                                  ...
                                  child: Column (
                                    children: [
                                      Image.asset("assets/interpretation.png", width: 64.0),
                                      SizedBox (height: 10.0),
                                      Text("View Past Activities", style: TextStyle (
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize:  20.0
                                      )),
